...
from Harmony.eval.classification_layer_decay.optim_factory import create_optimizer, get_parameter_groups, LayerDecayValueAssigner
...
from Harmony.models.dinov2_model.vision_transformer import VISION_TRANSFORMER_CLASSES
...
def get_args():
    ...
    parser = argparse.ArgumentParser('BEiT fine-tuning and evaluation script for image classification', add_help=False, parents=parents)
