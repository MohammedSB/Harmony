...
from Harmony.utils import trunc_normal_
...
class TextDistillationHead(nn.Module):
    def __init__(self, in_dim, out_dim, norm='bn', act='gelu', norm_last_layer=True, last_norm=None, nlayers=2, hidden_dim=1024, bottleneck_dim=256, **kwargs):
        super().__init__()
