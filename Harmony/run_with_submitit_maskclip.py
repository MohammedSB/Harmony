...
import Harmony.main_maskclip as main_maskclip
import submitit


def parse_args():
    parser = argparse.ArgumentParser("Submitit for Harmony", parents=[main_maskclip.get_args_parser()])
...
def main():
    ...
    executor.update_parameters(name="harmony")
